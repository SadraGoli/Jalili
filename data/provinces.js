...
const Provinces = {
  'آذربايجان شرقي': [
    ...
    'سراب',   'هاديشهر', 'بناب',
    'تسوج',   'اهر',     'هريس',
    'هشترود', 'ملكان',   'بستان آباد',
    'ورزقان', 'اسكو',    'ممقان',
    'صوفیان', 'ایلخچی',  'خسروشهر',
    'باسمنج', 'سهند'
  ],
  'آذربايجان غربي': [
    'اروميه',   'نقده',
  ...
  'تهران': [
    'تهران',     'ورامين',    'فيروزكوه',
    'ري',        'دماوند',    'اسلامشهر',
    'رودهن',     'لواسان',    'بومهن',
    'تجريش',     'فشم',       'كهريزك',
    'پاكدشت',    'چهاردانگه', 'شريف آباد',
    'قرچك',      'باقرشهر',   'شهريار',
    'رباط كريم', 'قدس',       'ملارد'
  ],
  'چهارمحال بختياري': [ 'شهركرد', 'فارسان', 'بروجن', 'چلگرد', 'اردل', 'لردگان' ],
  ...
  'فارس': [
    ...
    'فسا',        'مرودشت',  'آباده',
    'كازرون',     'سپيدان',  'لار',
    'فيروز آباد', 'جهرم',    'استهبان',
    'لامرد',      'مهر',     'حاجي آباد',
    'اردكان',     'صفاشهر',  'ارسنجان',
    'سوريان',     'فراشبند', 'سروستان',
    'زرقان',      'کوار',    'بوانات',
    'خرامه',      'خنج'
  ],
